...
for plat_i = 1:plat_size
    ...
    for ni =1:length(platoons{plat_i})
        ...
        % shadow trajectory: ts_prev,as_prev,vs_prev,ps_prev
        % starting point from: t_cur,v_cur,p_cur
        %forward acceleration: a_comfort
        %backward acceleration: a_comfort_dec
